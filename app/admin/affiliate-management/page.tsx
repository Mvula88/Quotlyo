      ...
      <main className="flex-1 space-y-4 p-8 pt-6">
        <div className="flex items-center justify-between space-y-2">
          ...
          <div className="flex items-center space-x-2">
            <Link href="/admin/affiliate-management/settings">
              <Button variant="outline">
                <Settings className="mr-2 h-4 w-4" />
                Program Settings
              </Button>
            </Link>
            <Link href="/admin/affiliate-management/new">
              <Button>
                            ...
                            <TableCell className="text-right">
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  ...
                                  <DropdownMenuItem>
                                    <Link href={`/admin/affiliate-management/${affiliate.id}`}>View details</Link>
                                  </DropdownMenuItem>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-center justify-between space-y-2 mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Link href="/admin/affiliate-management/commissions/new">
                      <Button size="sm">
